# 01 Что происходит после ввода URL
...
<details>
<summary><strong>Вопрос:</strong> Что такое URL и какие части URL реально уходят на сервер?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что такое DNS lookup?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что такое TLS handshake?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что такое HTTP request и HTTP response?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что происходит при redirect?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Когда подключается Service Worker?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Чем DOM отличается от HTML?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что такое CSSOM?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему обычный script может блокировать загрузку страницы?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что такое layout, paint и composite?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему HTML уже виден, но кнопки ещё не работают?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Какие процессы браузера участвуют в навигации?</summary>
