...
<details>
<summary><strong>Вопрос:</strong> Чем <code>revert</code> отличается от <code>reset</code> на практическом примере?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что делает <code>git reset --soft HEAD~1</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что делает <code>git reset --mixed HEAD~1</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Чем опасен <code>git reset --hard</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Чем <code>git restore file.ts</code> отличается от <code>git restore --staged file.ts</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Когда нужен <code>cherry-pick</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему нельзя постоянно синхронизировать долгоживущие ветки через <code>cherry-pick</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что сохраняет <code>git stash</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Можно ли считать stash надёжным долгосрочным хранилищем?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Как восстановить commit после ошибочного <code>reset --hard</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему reflog не является удалённой резервной копией?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Как отменить merge commit через <code>revert</code>?</summary>
