# Путь изменений в Git

<!-- CARD-NAV-TOP:START -->
[← 01 Что такое Git и зачем он frontend разработчику](<./01 Что такое Git и зачем он frontend разработчику.md>) · [↑ Git](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [03 Стратегии ветвления →](<./03 Стратегии ветвления.md>)
<!-- CARD-NAV-TOP:END -->
...
- [03 Стратегии ветвления](<./03 Стратегии ветвления.md>)
