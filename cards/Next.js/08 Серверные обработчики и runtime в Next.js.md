# Серверные обработчики и runtime в Next.js

<!-- CARD-NAV-TOP:START -->
[← 07 Server Actions и изменение данных](<./07 Server Actions и изменение данных.md>) · [↑ Next.js](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [09 Динамические маршруты и metadata →](<./09 Динамические маршруты и metadata.md>)
<!-- CARD-NAV-TOP:END -->
