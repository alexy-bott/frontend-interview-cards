...
<details>
<summary><strong>Вопрос:</strong> Чем серверная переменная окружения отличается от <code>NEXT_PUBLIC_</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему <code>NEXT_PUBLIC_</code> не меняется после запуска контейнера?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Можно ли хранить секрет в <code>next.config.js</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Чем rewrite отличается от redirect?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что содержит standalone output?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Когда подходит static export?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что нужно учесть при нескольких экземплярах Next.js?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Зачем собирать артефакт один раз, а не выполнять сборку в каждом окружении?</summary>
