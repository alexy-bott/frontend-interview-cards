...
<details>
<summary><strong>Вопрос:</strong> Чем Server Action отличается от Route Handler?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему проверку авторизации нужно выполнять внутри каждой action?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Чем валидация отличается от авторизации?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Чем <code>revalidateTag</code> отличается от <code>revalidatePath</code> после mutation?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Когда после action использовать <code>redirect</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Как показать состояние отправки формы?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Можно ли вызвать Server Action не из <code>&lt;form&gt;</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Как избежать двойного изменения данных при повторном клике или сетевом повторе?</summary>
