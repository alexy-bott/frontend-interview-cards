...
<!-- CARD-NAV-TOP:START -->
[← 01 Что такое Next.js и зачем он нужен](<./01 Что такое Next.js и зачем он нужен.md>) · [↑ Next.js](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [03 Server и Client Components →](<./03 Server и Client Components.md>)
<!-- CARD-NAV-TOP:END -->
...
- [12 Сложные маршруты в App Router](<./12 Сложные маршруты в App Router.md>)
- [11 Pages Router и загрузка данных](<./11 Pages Router и загрузка данных.md>)
