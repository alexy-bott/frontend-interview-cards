# 01 HTTP request response headers body
...
<details>
<summary><strong>Вопрос:</strong> Что такое HTTP header, или HTTP-заголовок?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Чем <code>Content-Type</code> отличается от <code>Accept</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что такое <code>Authorization</code> header и всегда ли авторизация работает через него?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему JavaScript не может прочитать <code>Set-Cookie</code> из <code>response.headers</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Чем HTTP-ошибка отличается от сетевой ошибки в <code>fetch</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему тело ответа обычно нельзя прочитать два раза?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Можно ли отправить тело в <code>GET</code>-запросе?</summary>
...
<details>
<summary><strong>Вопрос:</strong> У каких ответов нет тела?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему при отправке <code>FormData</code> не следует вручную задавать <code>Content-Type</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Чем тело запроса отличается от query-параметров?</summary>
