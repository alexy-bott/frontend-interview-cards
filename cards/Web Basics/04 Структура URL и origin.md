# Структура URL и origin

<!-- CARD-NAV-TOP:START -->
[← 03 HTTPS TLS и сертификаты](<./03 HTTPS TLS и сертификаты.md>) · [↑ Web Basics](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [05 REST API resource model →](<./05 REST API resource model.md>)
<!-- CARD-NAV-TOP:END -->
