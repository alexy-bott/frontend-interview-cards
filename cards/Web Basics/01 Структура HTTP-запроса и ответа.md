...
<!-- CARD-NAV-TOP:START -->
[↑ Web Basics](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [02 HTTP-методы и коды состояния →](<./02 HTTP-методы и коды состояния.md>)
<!-- CARD-NAV-TOP:END -->
...
- [02 HTTP-методы и коды состояния](<./02 HTTP-методы и коды состояния.md>)
