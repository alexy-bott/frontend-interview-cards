...
<!-- CARD-NAV-TOP:START -->
[← 04 Fetch API и управление запросом](<./04 Fetch API и управление запросом.md>) · [↑ Web API](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [06 Аутентификация и обновление токенов →](<./06 Аутентификация и обновление токенов.md>)
<!-- CARD-NAV-TOP:END -->
...
- [06 Аутентификация и обновление токенов](<./06 Аутентификация и обновление токенов.md>)
