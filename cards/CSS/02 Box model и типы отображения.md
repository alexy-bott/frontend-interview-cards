# Box model и типы отображения

<!-- CARD-NAV-TOP:START -->
[← 01 Каскад наследование и специфичность CSS](<./01 Каскад наследование и специфичность CSS.md>) · [↑ CSS](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [03 Основы Flexbox →](<./03 Основы Flexbox.md>)
<!-- CARD-NAV-TOP:END -->
