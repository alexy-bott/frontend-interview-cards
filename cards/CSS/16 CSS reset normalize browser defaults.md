...
<details>
<summary><strong>Вопрос:</strong> Почему <code>box-sizing</code> задают также <code>::before</code> и <code>::after</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему нельзя просто поставить <code>all: unset</code> для всех элементов?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Обязательно ли подключать готовый normalize.css?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему reset должен подключаться раньше компонентов?</summary>
