...
<!-- CARD-NAV-TOP:START -->
[← 14 Диагностика проблем CSS](<./14 Диагностика проблем CSS.md>) · [↑ CSS](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [16 CSS reset и normalize →](<./16 CSS reset и normalize.md>)
<!-- CARD-NAV-TOP:END -->
...
- [Каскад, наследование и специфичность](<./01 Каскад наследование и специфичность CSS.md>)
- [Валидация форм](<../Forms/05 Валидация форм.md>)
