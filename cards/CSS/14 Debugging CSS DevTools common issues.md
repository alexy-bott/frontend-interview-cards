...
<details>
<summary><strong>Вопрос:</strong> Чем computed styles отличаются от matched rules?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что значит зачёркнутое CSS-объявление в DevTools?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему CSS ломается только в production-сборке?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Как проверить, поддерживается ли CSS-свойство?</summary>
