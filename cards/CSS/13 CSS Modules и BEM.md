...
<!-- CARD-NAV-TOP:START -->
[← 12 Модульная архитектура Sass](<./12 Модульная архитектура Sass.md>) · [↑ CSS](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [14 Диагностика проблем CSS →](<./14 Диагностика проблем CSS.md>)
<!-- CARD-NAV-TOP:END -->
