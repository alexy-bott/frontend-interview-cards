...
<!-- CARD-NAV-TOP:START -->
[← 08 Адаптивный дизайн media и container queries](<./08 Адаптивный дизайн media и container queries.md>) · [↑ CSS](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [10 Анимации и transitions в CSS →](<./10 Анимации и transitions в CSS.md>)
<!-- CARD-NAV-TOP:END -->
