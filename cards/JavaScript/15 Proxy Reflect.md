...
<details>
<summary><strong>Вопрос:</strong> Почему ловушка <code>set</code> должна вернуть <code>boolean</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что такое инварианты Proxy?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Как Proxy используют для реактивности?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему методы <code>Map</code>, <code>Set</code> и private fields могут не работать через простой Proxy?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Можно ли использовать Proxy как проверку данных API?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что делает <code>Proxy.revocable</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Какие практические недостатки есть у Proxy?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Чем методы <code>Reflect</code> отличаются от похожих операторов?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что будет выведено и почему target содержит <code>50</code>?</summary>
