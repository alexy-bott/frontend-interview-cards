# EventTarget и пользовательские события

<!-- CARD-NAV-TOP:START -->
[← 35 localStorage sessionStorage IndexedDB](<./35 localStorage sessionStorage IndexedDB.md>) · [↑ JavaScript](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [37 URL и навигация через History API →](<./37 URL и навигация через History API.md>)
<!-- CARD-NAV-TOP:END -->
