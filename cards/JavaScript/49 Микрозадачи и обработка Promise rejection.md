# Микрозадачи и обработка Promise rejection

<!-- CARD-NAV-TOP:START -->
[← 48 WebSocket и обновления данных в реальном времени](<./48 WebSocket и обновления данных в реальном времени.md>) · [↑ JavaScript](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [50 Продвинутые приёмы работы с функциями →](<./50 Продвинутые приёмы работы с функциями.md>)
<!-- CARD-NAV-TOP:END -->
