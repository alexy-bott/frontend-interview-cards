...
<details>
<summary><strong>Вопрос:</strong> Почему метод теряет <code>this</code>, если передать его отдельно?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Можно ли повторным <code>bind</code> изменить уже связанный <code>this</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что произойдёт при вызове связанной функции через <code>new</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему <code>bind</code> может помешать <code>removeEventListener</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Как <code>this</code> работает в getter и унаследованном методе?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Чем <code>bind</code> отличается от стрелочной обёртки?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Как <code>this</code> связан со стрелочной функцией?</summary>
