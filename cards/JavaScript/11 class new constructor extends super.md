...
<details>
<summary><strong>Вопрос:</strong> Где хранятся методы и поля класса?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Когда инициализируются поля базового класса и наследника?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что именно настраивает <code>extends</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Чем <code>super.method()</code> отличается от <code>this.method()</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что произойдёт, если наследник не объявляет <code>constructor</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Чем приватное поле <code>#token</code> отличается от <code>private</code> в TypeScript?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Когда class field со стрелкой оправдан вместо метода?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Когда наследование лучше заменить композицией?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Как правильно создать собственный класс ошибки?</summary>
