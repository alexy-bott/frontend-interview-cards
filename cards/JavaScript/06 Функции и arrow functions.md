...
<details>
<summary><strong>Вопрос:</strong> Как определяется <code>this</code> у обычной функции?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему метод объекта обычно не стоит объявлять стрелкой?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что такое <code>arguments</code> и чем его заменить?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Может ли <code>bind</code> изменить <code>this</code> стрелочной функции?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Чем стрелочное поле класса отличается от метода прототипа?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Как <code>this</code> ведёт себя в обработчике DOM-события?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что такое чистая функция?</summary>
