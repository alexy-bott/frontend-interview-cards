...
<details>
<summary><strong>Вопрос:</strong> Почему <code>response.json()</code> возвращает Promise?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Можно ли прочитать body дважды?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Как обработать error body, если его формат неизвестен?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что делать с ответом <code>204 No Content</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Как отличить отмену от обычной сетевой ошибки?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Как задать timeout для <code>fetch</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что такое stale response и race condition в поиске?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Когда нужен <code>credentials: "include"</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что делает режим <code>no-cors</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Кеширует ли <code>fetch</code> ответы?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Когда запрос можно автоматически повторить?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему TypeScript-тип ответа не заменяет runtime validation?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Какие ошибки эта функция уже различает, а какой проверки всё ещё не хватает?</summary>
