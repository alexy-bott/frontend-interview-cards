...
<details>
<summary><strong>Вопрос:</strong> Что означают leading и trailing?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Для чего нужен <code>maxWait</code> у debounce?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Как устроен throttle?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему нужно сохранять <code>this</code> и аргументы?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что должны делать <code>cancel</code> и <code>flush</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему debounce может сломаться при каждом React render?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Как избежать stale closure в стабильной debounced function?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Нужно ли debounce-ить обновление controlled input?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Достаточно ли debounce для поиска по API?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Когда вместо throttle использовать <code>requestAnimationFrame</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Чем debounce отличается от <code>useDeferredValue</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Как тестировать debounce и throttle?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что будет выведено, если main thread не занят?</summary>
