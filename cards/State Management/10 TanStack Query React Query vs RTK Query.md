...
<details>
<summary><strong>Вопрос:</strong> Что такое <code>queryKey</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему все параметры <code>queryFn</code> должны входить в <code>queryKey</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Чем <code>staleTime</code> отличается от <code>gcTime</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Какие важные настройки по умолчанию есть у TanStack Query?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Как обновить кэш после mutation?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Как устроено оптимистичное обновление?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Чем отличается invalidation, то есть пометка query как устаревшей, в TanStack Query и RTK Query?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Можно ли использовать TanStack Query вместе с Redux Toolkit?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что важно при SSR?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Нормализует ли TanStack Query сущности между разными queries?</summary>
