# Асинхронная логика Redux Toolkit

<!-- CARD-NAV-TOP:START -->
[← 03 Основы Redux Toolkit](<./03 Основы Redux Toolkit.md>) · [↑ State Management](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [05 Селекторы и нормализация данных в Redux →](<./05 Селекторы и нормализация данных в Redux.md>)
<!-- CARD-NAV-TOP:END -->
