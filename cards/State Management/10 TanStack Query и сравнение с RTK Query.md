# TanStack Query и сравнение с RTK Query

<!-- CARD-NAV-TOP:START -->
[← 09 Выбор инструмента управления состоянием](<./09 Выбор инструмента управления состоянием.md>) · [↑ State Management](<./README.md>) · [⌂ Все разделы](<../../README.md>)
<!-- CARD-NAV-TOP:END -->
