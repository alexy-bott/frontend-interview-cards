...
<!-- CARD-NAV-TOP:START -->
[← 05 Селекторы и нормализация данных в Redux](<./05 Селекторы и нормализация данных в Redux.md>) · [↑ State Management](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [07 Кеш и обновление данных в RTK Query →](<./07 Кеш и обновление данных в RTK Query.md>)
<!-- CARD-NAV-TOP:END -->
