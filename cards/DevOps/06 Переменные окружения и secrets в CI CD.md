# Переменные окружения и secrets в CI CD

<!-- CARD-NAV-TOP:START -->
[← 05 Настройка Nginx для SPA](<./05 Настройка Nginx для SPA.md>) · [↑ DevOps](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [07 Диагностика проблем после deploy →](<./07 Диагностика проблем после deploy.md>)
<!-- CARD-NAV-TOP:END -->
...
- [07 Переменные окружения во frontend](<../Tooling/07 Переменные окружения во frontend.md>)
