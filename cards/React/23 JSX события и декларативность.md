# JSX события и декларативность

<!-- CARD-NAV-TOP:START -->
[← 22 Диагностика производительности React](<./22 Диагностика производительности React.md>) · [↑ React](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [24 Классовые компоненты и паттерны React →](<./24 Классовые компоненты и паттерны React.md>)
<!-- CARD-NAV-TOP:END -->
