# Классовые компоненты и паттерны React

<!-- CARD-NAV-TOP:START -->
[← 23 JSX события и декларативность](<./23 JSX события и декларативность.md>) · [↑ React](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [25 Специализированные хуки React →](<./25 Специализированные хуки React.md>)
<!-- CARD-NAV-TOP:END -->
