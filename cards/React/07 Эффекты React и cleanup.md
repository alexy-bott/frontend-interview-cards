# Эффекты React и cleanup

<!-- CARD-NAV-TOP:START -->
[← 06 useState и useReducer](<./06 useState и useReducer.md>) · [↑ React](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [08 Правила хуков и пользовательские хуки →](<./08 Правила хуков и пользовательские хуки.md>)
<!-- CARD-NAV-TOP:END -->
