# Разработка и сборка с Vite

<!-- CARD-NAV-TOP:START -->
[← 03 Semver и диапазоны версий](<./03 Semver и диапазоны версий.md>) · [↑ Tooling](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [05 Конфигурация Webpack →](<./05 Конфигурация Webpack.md>)
<!-- CARD-NAV-TOP:END -->
...
- [07 Переменные окружения во frontend](<./07 Переменные окружения во frontend.md>)
