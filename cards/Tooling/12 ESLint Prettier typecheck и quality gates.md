...
<details>
<summary><strong>Вопрос:</strong> Почему Prettier не заменяет ESLint?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему ESLint не заменяет TypeScript?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что такое flat config?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Зачем нужен <code>eslint-config-prettier</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему ESLint с информацией о типах работает медленнее?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Нужно ли запускать проверки в pre-commit и CI?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему <code>vite build</code> может пройти при ошибках TypeScript?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что означает <code>--max-warnings=0</code>?</summary>
