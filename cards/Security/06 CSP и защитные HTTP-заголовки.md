# CSP и защитные HTTP-заголовки

<!-- CARD-NAV-TOP:START -->
[← 05 Same-origin policy и CORS](<./05 Same-origin policy и CORS.md>) · [↑ Security](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [07 Ответственность frontend и backend в авторизации →](<./07 Ответственность frontend и backend в авторизации.md>)
<!-- CARD-NAV-TOP:END -->
