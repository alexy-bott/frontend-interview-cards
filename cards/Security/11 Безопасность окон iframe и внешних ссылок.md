# Безопасность окон iframe и внешних ссылок

<!-- CARD-NAV-TOP:START -->
[← 10 Механизмы аутентификации и авторизации](<./10 Механизмы аутентификации и авторизации.md>) · [↑ Security](<./README.md>) · [⌂ Все разделы](<../../README.md>)
<!-- CARD-NAV-TOP:END -->
...
- [09 Безопасность iframe](<../HTML/09 Безопасность iframe.md>)
- [05 Same-origin policy и CORS](<./05 Same-origin policy и CORS.md>)
