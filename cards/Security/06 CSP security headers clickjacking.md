...
<details>
<summary><strong>Вопрос:</strong> Что означают <code>default-src</code> и <code>script-src</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что такое CSP nonce и каким он должен быть?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Чем nonce отличается от hash в CSP?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему <code>unsafe-inline</code> ослабляет CSP?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что делает <code>'strict-dynamic'</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Как внедрять CSP, не сломав приложение?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Можно ли задать CSP через <code>&lt;meta&gt;</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Чем <code>frame-src</code> отличается от <code>frame-ancestors</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Как <code>frame-ancestors</code> защищает от clickjacking?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что делает HSTS и чего он не делает?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что делает <code>X-Content-Type-Options: nosniff</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Зачем нужна <code>Referrer-Policy</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что дают COOP, COEP и CORP?</summary>
