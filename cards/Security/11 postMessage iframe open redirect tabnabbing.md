...
<details>
<summary><strong>Вопрос:</strong> Что такое <code>postMessage</code> и зачем он нужен?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему опасно использовать <code>targetOrigin: '*'</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему проверки только <code>event.origin</code> недостаточно?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Как правильно сравнивать <code>event.origin</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Зачем валидировать <code>event.data</code>, если origin доверенный?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Нужно ли использовать <code>JSON.stringify</code> для <code>postMessage</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Как <code>postMessage</code> может привести к XSS?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что делает атрибут <code>sandbox</code> у iframe?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему сочетание <code>allow-scripts</code> и <code>allow-same-origin</code> опасно?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Чем CSP <code>frame-src</code> и <code>frame-ancestors</code> связаны с iframe?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что такое open redirect и чем он опасен?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Как безопасно обрабатывать <code>returnUrl</code> после login?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что такое reverse tabnabbing?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Чем <code>noopener</code> отличается от <code>noreferrer</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Достаточно ли проверить, что ссылка начинается с <code>https://</code>?</summary>
