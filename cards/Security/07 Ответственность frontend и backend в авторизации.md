# Ответственность frontend и backend в авторизации

<!-- CARD-NAV-TOP:START -->
[← 06 CSP и защитные HTTP-заголовки](<./06 CSP и защитные HTTP-заголовки.md>) · [↑ Security](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [08 Защита цепочки поставки frontend →](<./08 Защита цепочки поставки frontend.md>)
<!-- CARD-NAV-TOP:END -->
...
- [01 Модель угроз во frontend](<./01 Модель угроз во frontend.md>)
