...
<!-- CARD-NAV-TOP:START -->
[← 02 XSS во frontend и React](<./02 XSS во frontend и React.md>) · [↑ Security](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [04 Хранение access и refresh tokens →](<./04 Хранение access и refresh tokens.md>)
<!-- CARD-NAV-TOP:END -->
...
- [02 Свойства HTTP-методов](<../Web API/02 Свойства HTTP-методов.md>)
