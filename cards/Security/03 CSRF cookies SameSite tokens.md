# 03 CSRF cookies SameSite tokens
...
<details>
<summary><strong>Вопрос:</strong> Почему CSRF чаще связан с cookie-based авторизацией?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Возможен ли CSRF, если access token передается в <code>Authorization</code> header?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что именно делает атрибут <code>SameSite</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Чем site отличается от origin?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что такое synchronizer token pattern?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что такое double-submit cookie?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему token в пользовательском HTTP header (custom header) полезнее скрытого поля формы для SPA?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Зачем проверять <code>Origin</code> или <code>Referer</code>, если есть CSRF token?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что дают заголовки Fetch Metadata?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему CORS не является основной защитой от CSRF?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему <code>GET</code> не должен менять состояние?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Может ли XSS обойти CSRF-защиту?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что должен делать frontend для CSRF-защиты?</summary>
