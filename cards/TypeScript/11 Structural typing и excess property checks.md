...
<details>
<summary><strong>Вопрос:</strong> Почему прямой объект с лишним полем не проходит, а переменная проходит?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Гарантирует ли excess property check отсутствие лишних полей?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Чем structural typing отличается от nominal typing?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Как не перепутать <code>UserId</code> и <code>OrderId</code>, если оба представлены строкой?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Как <code>satisfies</code> помогает при создании объекта?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему structural typing важен для функций?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Проверяет ли TypeScript форму JSON от backend?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему первая передача вызывает ошибку, а вторая допустима? Исчезает ли <code>role</code> во втором случае?</summary>
