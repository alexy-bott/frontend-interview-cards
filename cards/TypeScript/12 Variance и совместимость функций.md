# 12 Variance и совместимость функций
...
<details>
<summary><strong>Вопрос:</strong> Что такое covariance на примере функции?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что такое contravariance у параметров функции?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Когда тип становится invariant?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что такое bivariance и почему TypeScript её допускает?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему методы и function properties могут проверяться по-разному?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Как variance проявляется в React?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему <code>readonly</code> массив безопаснее изменяемого при совместимости типов?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что означают модификаторы <code>in</code> и <code>out</code> у параметров типов?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему эта функция обратного вызова небезопасна?</summary>
