# Продвинутая типизация React-компонентов

<!-- CARD-NAV-TOP:START -->
[← 24 Типизация async-кода и ошибок](<./24 Типизация async-кода и ошибок.md>) · [↑ TypeScript](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [26 Основные настройки tsconfig →](<./26 Основные настройки tsconfig.md>)
<!-- CARD-NAV-TOP:END -->
...
- [19 Версии React 18 19 и 19.2](<../React/19 Версии React 18 19 и 19.2.md>)
