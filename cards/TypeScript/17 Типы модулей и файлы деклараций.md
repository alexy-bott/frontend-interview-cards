# Типы модулей и файлы деклараций

<!-- CARD-NAV-TOP:START -->
[← 16 Строгие настройки tsconfig](<./16 Строгие настройки tsconfig.md>) · [↑ TypeScript](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [18 Проверка данных с backend →](<./18 Проверка данных с backend.md>)
<!-- CARD-NAV-TOP:END -->
