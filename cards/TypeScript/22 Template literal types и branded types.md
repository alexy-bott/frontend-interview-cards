...
<details>
<summary><strong>Вопрос:</strong> Почему несколько объединений в шаблонном строковом типе могут замедлить TypeScript?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Можно ли извлечь часть строки через шаблонный строковый тип?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Как шаблонные строковые типы применяются к маршрутам?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Зачем нужен бренд, если можно создать псевдоним <code>type UserId = string</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Гарантирует ли branded type валидное значение?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Когда брендированный тип стоит использовать?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Сохраняется ли бренд после операций со строкой или числом?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что гарантируется при компиляции, а что проверяется во время выполнения?</summary>
