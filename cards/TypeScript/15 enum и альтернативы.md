...
<!-- CARD-NAV-TOP:START -->
[← 14 Утверждения и уточнение типов](<./14 Утверждения и уточнение типов.md>) · [↑ TypeScript](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [16 Строгие настройки tsconfig →](<./16 Строгие настройки tsconfig.md>)
<!-- CARD-NAV-TOP:END -->
