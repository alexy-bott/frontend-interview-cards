...
<!-- CARD-NAV-TOP:START -->
[← 18 Проверка данных с backend](<./18 Проверка данных с backend.md>) · [↑ TypeScript](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [20 Типизация форм и DOM в React →](<./20 Типизация форм и DOM в React.md>)
<!-- CARD-NAV-TOP:END -->
