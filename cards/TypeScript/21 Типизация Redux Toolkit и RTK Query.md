# Типизация Redux Toolkit и RTK Query

<!-- CARD-NAV-TOP:START -->
[← 20 Типизация форм и DOM в React](<./20 Типизация форм и DOM в React.md>) · [↑ TypeScript](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [22 Шаблонные и брендированные типы →](<./22 Шаблонные и брендированные типы.md>)
<!-- CARD-NAV-TOP:END -->
