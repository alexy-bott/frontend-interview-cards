...
<!-- CARD-NAV-TOP:START -->
[← 25 Продвинутая типизация React-компонентов](<./25 Продвинутая типизация React-компонентов.md>) · [↑ TypeScript](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [27 readonly и неизменяемость →](<./27 readonly и неизменяемость.md>)
<!-- CARD-NAV-TOP:END -->
