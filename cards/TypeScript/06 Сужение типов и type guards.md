...
<!-- CARD-NAV-TOP:START -->
[← 05 Union-типы и моделирование состояний](<./05 Union-типы и моделирование состояний.md>) · [↑ TypeScript](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [07 Generics →](<./07 Generics.md>)
<!-- CARD-NAV-TOP:END -->
