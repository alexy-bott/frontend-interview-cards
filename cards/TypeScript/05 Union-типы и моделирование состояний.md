# Union-типы и моделирование состояний

<!-- CARD-NAV-TOP:START -->
[← 04 type vs interface](<./04 type vs interface.md>) · [↑ TypeScript](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [06 Сужение типов и type guards →](<./06 Сужение типов и type guards.md>)
<!-- CARD-NAV-TOP:END -->
