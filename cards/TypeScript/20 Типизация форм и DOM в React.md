# Типизация форм и DOM в React

<!-- CARD-NAV-TOP:START -->
[← 19 Типизация React-компонентов](<./19 Типизация React-компонентов.md>) · [↑ TypeScript](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [21 Типизация Redux Toolkit и RTK Query →](<./21 Типизация Redux Toolkit и RTK Query.md>)
<!-- CARD-NAV-TOP:END -->
