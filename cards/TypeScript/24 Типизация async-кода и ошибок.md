# Типизация async-кода и ошибок

<!-- CARD-NAV-TOP:START -->
[← 23 Типизация методов массивов](<./23 Типизация методов массивов.md>) · [↑ TypeScript](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [25 Продвинутая типизация React-компонентов →](<./25 Продвинутая типизация React-компонентов.md>)
<!-- CARD-NAV-TOP:END -->
