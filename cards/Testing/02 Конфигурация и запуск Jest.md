# Конфигурация и запуск Jest

<!-- CARD-NAV-TOP:START -->
[← 01 Стратегия тестирования frontend](<./01 Стратегия тестирования frontend.md>) · [↑ Testing](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [03 Моки и таймеры в Jest →](<./03 Моки и таймеры в Jest.md>)
<!-- CARD-NAV-TOP:END -->
