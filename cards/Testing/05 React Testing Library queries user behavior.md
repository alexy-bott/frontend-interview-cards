# 05 React Testing Library queries user behavior
...
<details>
<summary><strong>Вопрос:</strong> Что такое семантическая роль (role) и доступное имя (accessible name)?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему <code>getByRole</code> обычно лучше <code>getByText</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему <code>queryBy</code> используют для отсутствия элемента?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что делать, если найдено несколько одинаковых элементов?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Для чего нужен <code>within</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Когда допустим <code>data-testid</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Нужно ли проверять обработчик <code>onClick</code> отдельно?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Как тестировать компонент с Redux, Router и QueryClient?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Как тестировать React portal?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Стоит ли проверять hooks через <code>renderHook</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Когда snapshot-тест полезен для React-компонента?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Может ли RTL проверить CSS, layout и реальный focus?</summary>
