...
<details>
<summary><strong>Вопрос:</strong> Чем средство запуска тестов (test runner) отличается от библиотек проверок и mocks?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Чем <code>setupFiles</code> отличается от <code>setupFilesAfterEnv</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Можно ли выбрать среду только для одного тестового файла?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Какие ограничения есть у <code>jsdom</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Зачем нужен <code>transform</code> и проверяет ли он типы TypeScript?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему зависимость из <code>node_modules</code> иногда вызывает <code>Unexpected token export</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Как Jest работает с ECMAScript modules?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему конфигурация Vite не применяется в Jest автоматически?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Чем отличаются <code>clearMocks</code>, <code>resetMocks</code> и <code>restoreMocks</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Чем <code>globalSetup</code> отличается от обычного setup-файла?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Как искать причину ошибки конфигурации Jest?</summary>
