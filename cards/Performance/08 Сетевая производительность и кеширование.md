# Сетевая производительность и кеширование

<!-- CARD-NAV-TOP:START -->
[← 07 Главный поток и тяжёлые задачи](<./07 Главный поток и тяжёлые задачи.md>) · [↑ Performance](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [09 Бюджет производительности и мониторинг →](<./09 Бюджет производительности и мониторинг.md>)
<!-- CARD-NAV-TOP:END -->
...
- [04 Размер бандла и стратегия загрузки](<./04 Размер бандла и стратегия загрузки.md>)
