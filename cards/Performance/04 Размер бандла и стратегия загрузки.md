...
<!-- CARD-NAV-TOP:START -->
[← 03 Критический путь рендеринга](<./03 Критический путь рендеринга.md>) · [↑ Performance](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [05 Оптимизация изображений и шрифтов →](<./05 Оптимизация изображений и шрифтов.md>)
<!-- CARD-NAV-TOP:END -->
