...
<details>
<summary><strong>Вопрос:</strong> Почему CSS блокирует первый render?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему обычный <code>&lt;script&gt;</code> блокирует разбор HTML?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Чем <code>defer</code>, <code>async</code> и <code>type="module"</code> отличаются по выполнению?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Чем DOM, CSSOM и render tree отличаются друг от друга?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Чем расчет style отличается от layout?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Чем paint отличается от raster и composite?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Почему <code>transform</code> и <code>opacity</code> часто дешевле <code>top</code>, <code>left</code>, <code>width</code> и <code>height</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что такое forced synchronous layout?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что такое layout thrashing?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Что делает preload scanner и почему он не находит все ресурсы?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Для чего нужны <code>contain</code> и <code>content-visibility</code>?</summary>
...
<details>
<summary><strong>Вопрос:</strong> Как определить, какой этап rendering создает задержку?</summary>
