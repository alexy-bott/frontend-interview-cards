# Главный поток и тяжёлые задачи

<!-- CARD-NAV-TOP:START -->
[← 06 Производительность React](<./06 Производительность React.md>) · [↑ Performance](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [08 Сетевая производительность и кеширование →](<./08 Сетевая производительность и кеширование.md>)
<!-- CARD-NAV-TOP:END -->
...
- [49 Микрозадачи и обработка Promise rejection](<../JavaScript/49 Микрозадачи и обработка Promise rejection.md>)
