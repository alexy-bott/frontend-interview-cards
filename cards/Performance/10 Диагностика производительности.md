...
<!-- CARD-NAV-TOP:START -->
[← 09 Бюджет производительности и мониторинг](<./09 Бюджет производительности и мониторинг.md>) · [↑ Performance](<./README.md>) · [⌂ Все разделы](<../../README.md>)
<!-- CARD-NAV-TOP:END -->
...
- [06 Производительность React](<./06 Производительность React.md>)
